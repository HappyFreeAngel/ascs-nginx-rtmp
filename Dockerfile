...
LABEL maintainer="Happy  <happyfreeangel@gmail.com>"
...
#更新列表
#RUN echo "deb http://mirrors.tuna.tsinghua.edu.cn/raspbian/raspbian/ buster main non-free contrib" >/etc/apt/sources.list \
